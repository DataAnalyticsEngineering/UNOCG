...
# %%
weights_uno = torch.load(os.path.join(config.data_path, "weights_uno_thermal_3d_dir.pt"), weights_only=True, map_location=device)
...
if show_plots:
    ...
    plt.savefig(os.path.join(config.results_path, "convergence_thermal_3d_dir.pdf"), dpi=300, bbox_inches=bbox)
    plt.show()
